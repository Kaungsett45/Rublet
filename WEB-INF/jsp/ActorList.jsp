...
<body>
     ...
     <p style="font-size:18px;">Total Actor Lists: <span style="color:blue;">${Actorcount}</span></p>
    ...
    <table  class="actorlist">
        ...
        <tr class="actortitle"> 
            <td class="customerliststyle">${actor.actor_name}</td>
            <td class="customerliststyle" >${actor.birth}</td>
            <td class="aboutcustomer">${actor.about}</td>
             <td class="edit"><a href="actoredit/${actor.actor_id}">Edit</a></td>
        </tr>
        </c:forEach>
    </table>
