...
<title>Fantasy</title>
    ...
    <link href="<c:url value="/CSS/comedy.css" />" rel="stylesheet">
...
<body>
    ...
    <!-- navigation bar-->
     ...
     <a href="Animation"><button id="category" class="animation">Animation</button></a>
      ...
      <c:forEach var="mov" items="${Comedy}">
       <div class="imgcontainershow">
       <img src="getComedyPhoto/<c:out value='${mov.movie_id}'/>" style="width:140px;" style="height:200px;">   
