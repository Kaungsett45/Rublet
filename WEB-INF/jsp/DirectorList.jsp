...
<body>
     ...
     <a href="ActressList"><button id="category" class="horror">Actress List</button></a>
     <a href="DirectorList"><button id="category" class="fantasy">Director List</button></a>
    </div>
     
     
     <p style="font-size:18px;">Total Director Lists: <span style="color:blue;">${directorcount}</span></p>
    ...
    <table  class="actorlist">
        ...
        <c:forEach var="actor" items="${directorlist}">
        <tr class="actortitle"> 
            <td class="customerliststyle">${actor.director_name}</td>
            <td class="customerliststyle" >${actor.birth}</td>
            <td class="aboutcustomer">${actor.about}</td>
             <td class="edit"><a href="directoredit/${actor.director_id}">Edit</a></td>
        </tr>
        </c:forEach>
    </table>
