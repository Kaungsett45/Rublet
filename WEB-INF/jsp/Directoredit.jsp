...
<body>
    ...
    <div class="login-form-container-admin">
         ...
         <div class="container">
        <div class="tab_box">
            <button class="tab_btn active">Director</button>
            <div class="line"></div>
        </div>
        <div class="content_box">
            <div class="content active">
         		       ...
         		       <form:form action="directoruploadedit"  modelAttribute="director"  enctype="multipart/form-data">
        		<form:hidden path="director_id" value="${director_id}"/>
