...
<title>Fantasy</title>
    ...
    <link href="<c:url value="/CSS/home.css" />" rel="stylesheet">
     <link href="<c:url value="/CSS/fantasy.css" />" rel="stylesheet">
...
<body>
  ...
  <div id="rightanothershownewcolor">
     ...
     <a href="Animation"><button id="category" class="animation">Animation</button></a>
      ...
      <c:forEach var="mov" items="${Fantasy}">
       <div class="imgcontainershow">
       <img src="getFantasyPhoto/<c:out value='${mov.movie_id}'/>" style="width:140px;" style="height:200px;">   
