...
<body>
         ...
         <div id="select">
            ...
            <ul id="list">
               ...
               <li class="options"><a  id="nthsr" href="directorsearch">Director</a></li>
       			 ...
       			 <form:form action="dbmsactorsearch" class="formsearch" modelAttribute="searchactor">
               		<form:input path="actor_name"  name="movie_title" type="text" placeholder="Search with movie_title"  class="search" />
               		 	</form:form>  </div>
   </div>
   ...
   <c:forEach var="mov" items="${actors}">
       <div class="imgcontainershow">
        <button id="titlewatchlist">${mov.actor_name}</button>
       <img src="getActorPhoto/<c:out value='${mov.actor_id}'/>" style="width:140px;" style="height:200px;">   
            
            <a href="actorviewdetail/${mov.actor_id}"><button id="watchlist">View Details</button></a>
        </div>
	</c:forEach>
