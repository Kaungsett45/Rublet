...
<body>
         ...
         <div id="select">
            ...
            <ul id="list">
               ...
               <li class="options"><a  id="nthsr" href="directorsearch">Director</a></li>
       			 ...
       			 <form:form action="searchactress" class="formsearch" modelAttribute="searchactress">
               		<form:input path="actress_name"  name="movie_title" type="text" placeholder="Search with movie_title"  class="search" />
               		 	</form:form>  </div>
   </div>
   ...
   <c:forEach var="mov" items="${actress}">
       <div class="imgcontainershow">
        <button id="titlewatchlist">${mov.actress_name}</button>
       <img src="getActressPhoto/<c:out value='${mov.actress_id}'/>" style="width:140px;" style="height:200px;">   
            
            <a href="actressviewdetail/${mov.actress_id}"><button id="watchlist">View Details</button></a>
        </div>
	</c:forEach>
