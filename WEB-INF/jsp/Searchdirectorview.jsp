...
<body>
         ...
         <div id="select">
            ...
            <ul id="list">
               ...
               <li class="options"><a  id="nthsr" href="moviesearch">Movie</a></li>
       			 ...
       			 <form:form action="searchdirector" class="formsearch" modelAttribute="searchdirector">
               		<form:input path="director_name"  name="movie_title" type="text" placeholder="Search with director_name"  class="search" />
               		 	</form:form>
               		 	</div>
   </div>
   ...
   <c:forEach var="mov" items="${director}">
       <div class="imgcontainershow">
        <button id="titlewatchlist">${mov.director_name}</button>
       <img src="getDirectorPhoto/<c:out value='${mov.director_id}'/>" style="width:140px;" style="height:200px;">   
            
            <a href="directorviewdetail/${mov.director_id}"><button id="watchlist">View Details</button></a>
        </div>
	</c:forEach>
