            ...
            <ul id="list">
               ...
               <li class="options"><a  id="nthsr" href="directorsearch">Director</a></li>
       			 ...
       			 <form:form action="searchactress" class="formsearch" modelAttribute="searchactress">
               		<form:input path="actress_name"  name="movie_title" type="text" placeholder="Search with actress_name"  class="search" />
               		 	</form:form>  </div>
   </div>
      ...
      <!-- drop Down Menu -->
       ...
       <img src="getMoviePhoto/<c:out value='${mov.movie_id}'/>" style="width:140px;" style="height:200px;">   
        ...
        <div id="nav">
              <a href="Home"> <h2>Rublat</h2> </a>
             <form:form action="searchactress" class="formsearch" modelAttribute="searchactress">
               		<form:input path="actress_name"  name="movie_title" type="text" placeholder="  Search movies.."  class="search" />
