         ...
         <div id="select">
            ...
            <ul id="list">
               ...
               <li class="options"><a  id="nthsr" href="/ReworkRatingandComment/actresssearch">Actress</a></li>
       				 ...
       				 <form:form action="/ReworkRatingandComment/searchdirector" class="formsearch" modelAttribute="searchdirector">
     ...
     <!--body about actor-->
        <div id="leftcontainerdesign">
            ...
            <div class="castcontainer">
               <img src="getimgDirector/<c:out value='${directorview.director_id}'/>">
        
            </div>

            <div id="castabout">
                <p class="name">${directorview.director_name}</p>
                <p class="birth">Birth :: ${directorview.birth}</p>
...
<div class="anther">
          ...
          <c:forEach var="mov" items="${directormovie}">
